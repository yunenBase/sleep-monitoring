...
frame_count = 0
capture_count = 0  # Variabel baru untuk penamaan file gambar
...
while True:
    ...
    # Menggambar bounding box pada frame yang akan ditampilkan (frame_for_upload)
    for obj_id, obj_data in tracked_boxes.items():
    ...
    if key == ord('c'):
        capture_count += 1
        # Simpan frame asli ('frame') tanpa bounding box
